...
import { useScalesPage } from '@/features/scales/hooks/useScalesPage';

export default function ScalesPage() {
  const { query, recoInput, recommended, loadingReco, filtered, setQuery, setRecoInput, handleRecommend } =
    useScalesPage();
